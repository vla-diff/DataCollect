...
private:
  ...
  ros::Subscriber                   rc_sub_, odom_sub_, px4_state_sub_;
  ros::Publisher                    px4ctrl_cmd_pub_, rc_ctrl_marker_pub_, px4ctrl_takeoff_land_pub_;
  ros::Publisher                    uav_actions_pub_;
  ros::Timer                        fsm_exec_timer_, fsm_vis_timer_;
  ...
  void holdPosition(const Eigen::Vector3d &pos, const double &yaw);
