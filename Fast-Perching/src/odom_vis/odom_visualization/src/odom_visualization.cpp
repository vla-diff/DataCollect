...
int main(int argc, char** argv) {
  ...
  // n.param("mesh_resource", mesh_resource, std::string("package://odom_visualization/meshes/hummingbird.mesh")); // TODO
  // n.param("mesh_resource", mesh_resource, std::string("/home/ta/VLA/UnityVisExample/Fast-Perching/src/odom_vis/odom_visualization/meshes/f250.dae"));
  mesh_resource = "/home/ta/VLA/UnityVisExample/Fast-Perching/src/odom_vis/odom_visualization/meshes/f250.dae";
